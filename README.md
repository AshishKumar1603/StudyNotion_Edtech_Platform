...
<div align="center">
  ...
  <h3> Check out at https://study-notion-edtech-platform-mu-virid.vercel.app/</h3>
</div>
   ...
   2] ***For MONGODB_URL follow below steps –***
    ...
    - If you want to connect using MONGO_ATLAS, then do the following steps
      ...
      - Once you login, click on create button
       ...
       #### Step 1: Open MongoDB Dashboard
![Dashboard](./assets/screenshots/img1.png)

#### Step 2: Click on Connect
![Connect](./assets/screenshots/img2.png)

#### Step 3: Copy Connection String
![Connection String](./assets/screenshots/img3.png)
